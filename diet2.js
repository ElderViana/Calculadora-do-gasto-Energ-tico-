...
let foods = [
	{typeMeal: "Café da manhã", name: "Pão integral", quantity: 1, unitOfMeasure: "Unidade", carbohydrate: 12.27, protein: 2.37, fat: 1.07, calories: 68},
	...
	{typeMeal: "Café da manhã", name: "Açúcar", quantity: 1, unitOfMeasure: "Colher de sopa", carbohydrate: 4.2, protein: 0, fat: 0, calories: 16},
	{typeMeal: "Café da manhã", name: "Ovo grande", quantity: 1, unitOfMeasure: "Unidade", carbohydrate: 0.38, protein: 6.29, fat: 4.97, calories: 74},
	...
	{typeMeal: "Lanche da manhã", name: "Aveia", quantity: 1, unitOfMeasure: "Colher de sopa", carbohydrate: 8.55, protein: 2.18, fat: 1.18, calories: 53},
	{typeMeal: "Lanche da manhã", name: "Pasta de amendoim", quantity: 1, unitOfMeasure: "Colher de sopa", carbohydrate: 2.99, protein: 3.67, fat: 7.48, calories: 88},
	...
	{typeMeal: "Almoço", name: "Arroz integral", quantity: 1, unitOfMeasure: "Colher de sopa", carbohydrate: 1.72, protein: 0.17, fat: 0.06, calories: 8.33},
	...
	{typeMeal: "Almoço", name: "Feijão", quantity: 1, unitOfMeasure: "Colher de sopa", carbohydrate: 4.5, protein: 1.45, fat: 0.125, calories: 25},
	...
	{typeMeal: "Jantar", name: "Sardinha enlatada", quantity: 1, unitOfMeasure: "Unidade", carbohydrate: 0, protein: 22.65, fat: 10.53, calories: 191},
	...
	{typeMeal: "Jantar", name: "Azeite", quantity: 1, unitOfMeasure: "Colher de sopa", carbohydrate: 0, protein: 0, fat: 13.5, calories: 119},
...
if(i < 6 ){
	cellAlimento1.innerHTML = foods[i].name;
	cellQuantidade1.innerHTML = `${foods[i].quantity} ${foods[i].unitOfMeasure}`;
}
i+=6
if(i < 11){
	cellAlimento2.innerHTML = foods[i].name;
	cellQuantidade2.innerHTML = foods[i].quantity;
}
i+=5
if(i < 12){
	cellAlimento3.innerHTML = foods[i].name;
	cellQuantidade3.innerHTML = foods[i].quantity;
}
i++
if(i < 13){
	cellAlimento4.innerHTML = foods[i].name;
	cellQuantidade4.innerHTML = foods[i].quantity;
}
i++
if(i < 22){
	cellAlimento5.innerHTML = foods[i].name;
	cellQuantidade5.innerHTML = foods[i].quantity;
}
i+=9
if( i < 27){

	cellAlimento6.innerHTML = foods[i].name;
	cellQuantidade6.innerHTML = foods[i].quantity;
}
i+=5
if(i < 35){
	cellAlimento7.innerHTML = foods[i].name;
	cellQuantidade7.innerHTML = foods[i].quantity;
}
i+=8
if(i < 36){
	cellAlimento8.innerHTML = foods[i].name;
	cellQuantidade8.innerHTML = foods[i].quantity;
}
i-=35
...
let pre = [
	{typeMeal: "Pré-Treino", name: "Batata doce", quantity: 100, unitOfMeasure: "g", carbohydrate: 25.88, protein: 2.48, fat: 0.13, calories: 112}]
	let pos = [
	{typeMeal: "Pos-Treino", name: "Whey concentrado", quantity: 30, unitOfMeasure: "g", carbohydrate: 5, protein: 24, fat: 0, calories: 116}]
let almoco = [
	{typeMeal: "Almoço", name: "Arroz integral", quantity: 1, unitOfMeasure: "Colher de sopa", carbohydrate: 1.72, protein: 0.17, fat: 0.06, calories: 8.33},
	{typeMeal: "Almoço", name: "Mandioca", quantity: 100, unitOfMeasure: "g", carbohydrate: 37.46, protein: 1.34, fat: 2.04, calories: 173},
	{typeMeal: "Almoço", name: "Filé de frango ", quantity: 100, unitOfMeasure: "g", carbohydrate: 0, protein: 31.02, fat: 3.57, calories: 165},
...
for( i = 0; i < foods.length; i++){
	...
	let cellUnidade = linha.insertCell(3)
	let cellCarboidratos = linha.insertCell(4);
	let cellProteinas = linha.insertCell(5);
	let cellLipidios = linha.insertCell(6);
	let cellCalorrias = linha.insertCell(7);
	

	cellRefeicoes.innerHTML = foods[i].typeMeal;
	cellAlimentos.innerHTML = foods[i].name;
	cellPorcoes.innerHTML = foods[i].quantity;
	cellUnidade.innerHTML = foods[i].unitOfMeasure;
